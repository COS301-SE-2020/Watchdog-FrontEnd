...
class DetectedImages extends Component<propsDetectedImages, stateDetectedImages> {
    constructor(props: propsDetectedImages) {
        ...
        this.removeDetected = this.removeDetected.bind(this)
    }
    ...
    async removeDetected(val){
        ...
        await deleteIdentity(val, ()=>{
            ...
            this.toast.show({ severity: 'error', summary: 'Error', detail: 'Unable to remove', life: 3000 })
        }, 'blacklist')
        this.setState({ loading: false })
                ...
                <div key={index + 1} className='p-col-12 p-md-6 p-lg-3'>
                    <div className="p-grid p-shadow-6" style={{ paddingBottom: '5px' }}>
                        ...
                        <div className=' p-col-12 ' style={{ textAlign: 'center' }}>
                            ...
                            }} label="Add To Identities" className="p-button-success" />
                        ...
                        <div className=' p-col-12 ' style={{ textAlign: 'center' }}>
                            ...
                            <Button style={{width:'100%'}} onClick={() => {
                                this.removeDetected(item.id)
                            }} label="Remove" className="p-button-danger" />
