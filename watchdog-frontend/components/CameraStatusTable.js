...
import { Table, Badge, Panel, Icon, Avatar, IconButton } from 'rsuite'
...
class CameraStatusTable extends Component {
    ...
    render() {
        ...
        return (
            <Panel header={<div><IconButton onClick={this.handleRefresh} icon={<Icon icon="refresh" />} placement="left">
                Camera Status
